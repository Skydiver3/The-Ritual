...
namespace DollarRecognizer
{
	...
	/*	addTemplate("RightToLeftLine", samples.getGestureRightToLeftLine());
		...
		CustomGestures customSamples;
		addTemplate("Z", customSamples.getGestureZ());
		addTemplate("Light", customSamples.getGestureLight1());
		addTemplate("Light", customSamples.getGestureLight2());
		addTemplate("Destruction", customSamples.getGestureDestruction1());
		addTemplate("Destruction", customSamples.getGestureDestruction2());
		addTemplate("Reconstruction", customSamples.getGestureReconstruction1());
		addTemplate("Reconstruction", customSamples.getGestureReconstruction2());
	}
